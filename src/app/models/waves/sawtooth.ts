...
export class SawtoothWave extends Wave {
	public name = 'Sawtooth Wave';
	public description = 'a/n_i * sin(n_i * b * pi * x + c) + d Sum 1 to N';
	public constants = {
	...
	public id = uniqueId('sawtooth_wave_');
	f(x: number): number {
		const series = range(1, this.constants['N'].value + 1, 1);
